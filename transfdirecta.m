function varargout = transfdirecta(varargin)
% TRANSFDIRECTA MATLAB code for transfdirecta.fig
%      TRANSFDIRECTA, by itself, creates a new TRANSFDIRECTA or raises the existing
%      singleton*.
%
%      H = TRANSFDIRECTA returns the handle to a new TRANSFDIRECTA or the handle to
%      the existing singleton*.
%
%      TRANSFDIRECTA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRANSFDIRECTA.M with the given input arguments.
%
%      TRANSFDIRECTA('Property','Value',...) creates a new TRANSFDIRECTA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before transfdirecta_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to transfdirecta_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help transfdirecta

% Last Modified by GUIDE v2.5 06-Jun-2019 18:03:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @transfdirecta_OpeningFcn, ...
                   'gui_OutputFcn',  @transfdirecta_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before transfdirecta is made visible.
function transfdirecta_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to transfdirecta (see VARARGIN)

% Choose default command line output for transfdirecta
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes transfdirecta wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = transfdirecta_OutputFcn(hObject, eventdata, handles) 
...
% Hints: get(hObject,'String') returns contents of sup as text
%        str2double(get(hObject,'String')) returns contents of sup as a double


% --- Executes during object creation, after setting all properties.
function sup_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sup (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
FUNCION=inline(func);
TRANSFORMADAF=inline(fourier(func));
MAGNITUD=inline(abs(fourier(func)));
FASE=inline(phase(fourier(func)));
for i=1:200
    FAS(i)=FASE(i/200);
end
switch opcion
